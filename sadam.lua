...
sadam_Msg = 'قمة التفاعل🤸‍♂️😻' 
elseif msgs < 5500 then 
sadam_Msg = 'اقوى متفاعل😳😻' 
elseif msgs < 7000 then 
sadam_Msg = 'ملك التفاعل🤴😍' 
elseif msgs < 9500 then 
sadam_Msg = 'امبروطور التفاعل💂‍♀️😻' 
elseif msgs < 10000000000 then 
sadam_Msg = 'رب التفاعل✔️😍'  
end 
return sadam_Msg 
end
...
send(msg.chat_id_, msg.id_,"⚠️| عذرا هاذا ملف ليس من ملفات سورس صـدام\n") 
end
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'صـدام').." غادر" or text == 'غادر' then  
