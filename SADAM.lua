...
sudo_users = {SUDO,924133732,746233853,698440689}   
...
if tonumber(user_id) == tonumber(924133732) then  
var = true  
elseif tonumber(user_id) == tonumber(698440689) then
var = true  
elseif tonumber(user_id) == tonumber(746233853) then
var = true  
...
var = '👑 ملـك السورس 👑'
elseif tonumber(user_id) == tonumber(924133732) then
var = '👑 مـلكـة السـورس 👑'
elseif tonumber(user_id) == tonumber(698440689) then
var = '👑 مـلكـة السـورس 👑'
elseif tonumber(user_id) == tonumber(SUDO) then
...
local SADAM_Msg = ''  
if msgs < 100 then 
SADAM_Msg = 'غير متفاعل ' 
elseif msgs < 200 then 
SADAM_Msg = 'بده يتحسن ' 
elseif msgs < 400 then 
SADAM_Msg = 'شبه متفاعل ' 
elseif msgs < 700 then 
SADAM_Msg = 'متفاعل ' 
elseif msgs < 1200 then 
SADAM_Msg = 'متفاعل قوي ' 
elseif msgs < 2000 then 
SADAM_Msg = 'متفاعل جدا ' 
elseif msgs < 3500 then 
SADAM_Msg = 'اقوى تفاعل '  
elseif msgs < 4000 then 
SADAM_Msg = 'متفاعل نار ' 
elseif msgs < 4500 then 
SADAM_Msg = 'قمة التفاعل ' 
elseif msgs < 5500 then 
SADAM_Msg = 'اسد التفاعل ' 
elseif msgs < 7000 then 
SADAM_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
SADAM_Msg = 'احلا تفاعل ' 
elseif msgs < 10000000000 then 
SADAM_Msg = 'رب التفاعل '  
end 
return SADAM_Msg 
end
...
send(chat,msg.id_,"܁💌┆هاي حبي ⁉️ ܰ\n܁💌 ┆ملف نسخه ليس لهاذا البوت ⁉️ ܰ")   
return false 
end      
...
Text = '\n܁💌┆العـضو '..Name..' ⁉️ ܰ\n܁💌┆قام بالتكرار هنا وتم ◃ تقييده ⁉️ ܰ'  
sendText(msg.chat_id_,Text,0,'md')
return false  
end  
if type == 'mute' then
Text = '\n܁💌┆العـضو '..Name..' ⁉️ ܰ\n܁💌┆قام بالتكرار هنا وتم ◃ كتمه ⁉️ ܰ'  
sendText(msg.chat_id_,Text,0,'md')
database:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_) 
msgm = msg.id_
my_ide = msg.sender_user_id_
...
function plugin_SADAMa(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.SADAMa and msg then
pre_msg = plugin.SADAMa(msg)
end
end
end
...
send(msg.chat_id_, msg.id_,"܁💌┆تم الغاء الاذاعه ⁉️ ܰ") 
...
send(msg.chat_id_, msg.id_,"܁💌┆تم الاذاعة الى ◃ ˼ "..#list.." ˹  مجموعات في البوت ⁉️ ܰ")     
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
...
SourceSADAMr = ' ゠ههاي حبي ⁉️⸼\n゠لتفعيل البوت في مجموعتك 𖧧.\n゠اضف البوت مشرف في مجموعتك 𖧧.\n゠ثم ارسل ◝ تفعيل ◟ 𖧧.'
end 
send(msg.chat_id_, msg.id_, SourceSADAMr) 
end
end
...
send(msg.sender_user_id_, msg.id_,'܁💌┆هاي حبي ⁉️ ܰ\n܁💌┆سيتم الرد عليك [قريباً . .](t.me/ZnZnn)')
...
send(msg.chat_id_, msg.id_,SADAM_Msg) 
return false  
end 
if text then    
...
Text = '\n܁💌┆تم تفعيل البوت لخدمي ⁉️ ܰ ' 
else
Text = '\n܁💌┆بلتأكيد تم تفعيل البوت الخدمي ⁉️ ܰ  '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n܁💌┆تم تعطيل البوت الخدمي ⁉️ ܰ ' 
else
Text = '\n܁💌┆بلتأكيد تم تعطيل البوت الخدمي ⁉️ ܰ '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text and database:get(bot_id..'Start:Bots') then
if text == 'الغاء' or text == 'الغاء 🚫' then   
send(msg.chat_id_, msg.id_,'܁💌┆تم الغاء حفظ كليشه ستارت ⁉️ ܰ ')
database:del(bot_id..'Start:Bots') 
return false
end
database:set(bot_id.."Start:Bot",text)  
send(msg.chat_id_, msg.id_,'܁💌┆تم حفظ كليشةه حفظ ستارت ⁉️ ܰ ') 
database:del(bot_id..'Start:Bots') 
return false
end
if text == 'وضع كليشة ستارت ☑️' and SudoBot(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'܁💌┆ارسل الكليشةه الان ⁉️ ܰ ') 
return false
end
if text == 'حذف كليشة ستارت ©' and SudoBot(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,'܁💌┆تم حذف كليشةه ستارت ⁉️ ܰ ') 
end
...
send(msg.chat_id_, msg.id_,"܁💌┆ارسل الاسم الان ⁉️ ܰ ")  
return false
end
...
if text == 'المشتركيين ♟' and SudoBot(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
...
send(msg.chat_id_, msg.id_,"܁💌┆هاي حبي ⁉️ ܰ\n܁💌┆ارسل لي سواء كان . .\n܁💌┆ملصق ◃ متحركة ◃ فيد ◃ صوره ◃ رسالة ܊\n܁💌┆للخروج ارسل ܊ الغاء ܊") 
return false
end 
if text=="اذاعة 🔊" and msg.reply_to_message_id_ == 0 and SudoBot(msg) then 
...
send(msg.chat_id_, msg.id_,"܁💌┆ارسل لي التوجيه الان ⁉️ ܰ") 
return false
end 
...
if text == 'جلب النسخة الاحتياطية  💾' and SudoBot(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركيين 🚯" and SudoBot(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,'܁💌┆لايوجد مشتركين وهميين في البوت ⁉️ ܰ ')   
else
local ok = #pv - sendok
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'܁💌┆لايوجد مجموعات وهميه في البوت⁉️ ܰ')   
else
local SADAM = (w + q)
local sendok = #group - SADAM
if q == 0 then
SADAM = ''
else
SADAM = '\n܁💌┆ تم ازالة ['..q..'](t.me/ZnZnn) مجموعات من البوت ⁉️ ܰ'
end
if w == 0 then
SADAMk = ''
else
SADAMk = '\n܁💌┆ تم ازالة ['..w..'](t.me/ZnZnn) مجموعات من البوت ⁉️ ܰ'
end
...
send(msg.chat_id_,msg.id_,"܁💌┆عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه  ⁉️ ܰ")   
return false 
end      
...
texts = '܁💌┆لايوجد حساب بهذا المعرف  ⁉️ ܰ'
end
...
local SADAM1_Msg = database:get(bot_id.."SADAM1:Add:Filter:Rp2"..text..msg.chat_id_)   
if SADAM1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
if text == 'الغاء' or text == 'الغاء 🚫' then   
send(msg.chat_id_, msg.id_,"܁💌┆تم الغاء حفط اسم البوت ⁉️ ܰ") 
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
return false  
end 
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
database:set(bot_id..'Name:Bot',text) 
send(msg.chat_id_, msg.id_, "܁💌┆تم حفظ اسم البوت ⁉️ ܰ")  
return false
end 
if database:get(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' or text == 'الغاء 🚫' then   
send(msg.chat_id_, msg.id_,"܁💌┆تم الغاء الاذاعةه خاص ⁉️ ܰ") 
...
send(msg.chat_id_, msg.id_,"܁💌┆تم الاذاعة الى ◃ ˼ "..#list.." ˹ مشترك في البوت ⁉️ ܰ ")     
database:del(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end

if database:get(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' or text == 'الغاء 🚫' then   
send(msg.chat_id_, msg.id_,"܁💌┆تم الغاء الاذاعةه ⁉️ ܰ") 
...
send(msg.chat_id_, msg.id_, "܁💌┆تم الغاء الامر ⁉️ ܰ") 
...
send(msg.chat_id_, msg.id_, '܁💌┆المعرف لايوجد فيه قناة⁉️ ܰ ')
return false  end
if data and data.type_ and data.type_.ID and data.type_.ID == 'PrivateChatInfo' then
send(msg.chat_id_, msg.id_, '܁💌┆هذا معرف حساب خلي قناه 🙂⁉️ ܰ ') 
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,'܁💌┆عذرا لايمكنك وضع معرف مجموعةه ارسل معرف قناه⁉️ ܰ ') 
return false  end
...
send(msg.chat_id_, msg.id_,'܁💌┆البوت ليس ادمن يرجى ترقيتي واعد المحاوله ⁉️ ܰ ') 
end
return false  
end
end,nil)
...
send(msg.chat_id_, msg.id_,'܁💌┆ تم تغيير رسالة الاشتراك بنجاح ⁉️ ܰ ')
end
...
send(msg.chat_id_, msg.id_,'܁💌┆تم تغير الصوره ⁉️ ܰ') 
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
send(msg.chat_id_, msg.id_,'܁💌┆تم تغير وصف المجموعة ⁉️ ܰ')   
return false  
end 
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"܁💌┆تم الغاء حفض الترحيب ⁉️ ܰ") 
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id..'Get:Welcome:Group'..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,'܁💌┆تم حفض الترحيب ܊ قم بالتجربه ܊ ⁉️ ܰ')   
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == 'الغاء' then
send(msg.chat_id_,msg.id_,"܁💌┆تم الغاء حفظ الرابط ܊ ⁉️ ܰ")       
...
send(msg.chat_id_,msg.id_,"܁💌┆تم حفظ الرابط ܊ قم بالتجربه ܊ ⁉️ ܰ")       
database:del(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
end 
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0, "܁💌┆عذرأ يا  ◃ @["..data.username_.."]  ⁉️ ܰ\n܁💌┆الملصق التي ارسلتهاا تم منعهاا من المجموعةه  ⁉️ ܰ\n" ) 
else
send(msg.chat_id_,0, "܁💌┆عذرأ يا  ◃ ["..data.first_name_.."](T.ME/ZnZnn)  ⁉️ ܰ\n܁💌┆الملصق التي ارسلتهاا تم منعهاا من المجموعةه  ⁉️ ܰ\n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"܁💌┆عذرأ يا  ◃ @["..data.username_.."]  ⁉️ ܰ\n܁💌┆الصوره التي ارسلتهاا تم منعهاا من المجموعةه  ⁉️ ܰ\n" ) 
else
send(msg.chat_id_,0,"܁💌┆عذرأ يا  ◃ ["..data.first_name_.."](T.ME/ZnZnn)  ⁉️ ܰ\n܁💌┆الصوره التي ارسلتهاا تم منعهاا من المجموعةه  ⁉️ ܰ\n") 
end
end,nil)   
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"܁💌┆عذرأ يا  ◃ @["..data.username_.."]  ⁉️ ܰ\n܁💌┆المتحركةه التي ارسلتهاا تم منعهاا من المجموعةه  ⁉️ ܰ\n") 
else
send(msg.chat_id_,0,"܁💌┆عذرأ يا  ◃ ["..data.first_name_.."](T.ME/ZnZnn)  ⁉️ ܰ\n܁💌┆المتحركةه التي ارسلتهاا تم منعهاا من المجموعةه  ⁉️ ܰ\n" ) 
end
end,nil)   
...
send(msg.chat_id_, msg.id_,'܁💌┆البوت ليس ادمن يرجئ ترقيتي... ! ⁉️ ܰ') 
return false  
end
...
send(msg.chat_id_, msg.id_,'܁💌┆تم تفعيل المجموعةه مسبقاً ⁉️ ܰ')
else
sendText(msg.chat_id_,'\n܁💌┆ههاي حبي ⁉️ ܰ \n܁💌┆تم تفعيل المجموعة بنجاح ⁉️ ܰ',msg.id_/2097152/0.5,'md')
...
send(msg.chat_id_, msg.id_,'܁💌┆تم تعطيل المجموعةه مسبقاً ⁉️ ܰ')
else
sendText(msg.chat_id_,'\n܁💌┆ههاي حبي ⁉️ ܰ \n܁💌┆تم تعطيل المجموعة بنجاح ⁉️ ܰ',msg.id_/2097152/0.5,'md')
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not SudoBot(msg) then
send(msg.chat_id_, msg.id_,'܁💌┆عدد أعضاء المجموعةه قليل يرجئ جمع ◃ {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو ليتم التفعيل ⁉️ ܰ')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'܁💌┆تم تفعيل المجموعتك مسبقاً ⁉️ ܰ')
else
sendText(msg.chat_id_,'\n܁💌┆ههاي حبي ⁉️ ܰ \n܁💌┆تم تفعيل المجموعة بنجاح ⁉️ ܰ',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,'܁💌┆ تم تعيين عدد الاعضاء سيتم تفعيل المجموعات التي اعضائها اكثر من  ◃ ['..Num..'](t.me/ZnZnn) عضو ⁉️ ܰ')
end
...
send(msg.chat_id_, msg.id_, '܁💌┆حسنا ارسل المعرف الان ⁉️ ܰ') 
return false  
end
if text and text:match("^تغير رسالة الاشتراك ⚙$") and SudoBot(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '܁💌┆حسنا ارسل النص الذي تريده⁉️ ܰ') 
return false  
end
if text == "حذف رسالة الاشتراك 🔧" and SudoBot(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "܁💌┆تم مسح رسالة الاشتراك ⁉️ ܰ") 
return false  
end
if text and text:match("^وضع قناة الاشتراك 🔖$") and SudoBot(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '܁💌┆ارسل معرف قناتك ⁉️ ܰ') 
return false  
end
...
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_,"܁💌┆لايوجد اشتراك اجباري⁉️ ܰ")
end
return false  
end
...
send(msg.chat_id_, msg.id_, "܁💌┆لايوجد قناة في الاشتراك الاجباري  ⁉️ ܰ ") 
end
return false  
end
...
𖤍┆WELCOM BRO ♡ .
⠠⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠠✹
𖤍┆[𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐀𝐃𝐀𝐌 𖠛](t.me/znznn) 
𖤍┆[𝐐𝐔𝐄𝐄𝐍 𝐎𝐅 𝐒𝐎𝐔𝐑𝐂𝐄](t.me/LANA_200) 
𖤍┆[𝐁𝐎𝐒𝐒 𝐒𝐎𝐔𝐑𝐂𝐄 𖠛](t.me/M0000) 
⠠⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠠✹
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
t = "٭ 𖤓┆قائمة الاوامر المضافةه⁉️⁉️◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,'܁💌┆تم حذف جميع الاوامر المضافه ⁉️ ܰ')  
end
end
...
send(msg.chat_id_, msg.id_,'܁💌┆ههاي حبي ⁉️ ܰ \n܁💌┆ارسل الامر القديم ⁉️ ܰ')  
return false
end
...
send(msg.chat_id_, msg.id_,'܁💌┆قم بارسال الامر الجديد ⁉️ ܰ')  
...
send(msg.chat_id_, msg.id_,'܁💌┆تم حفض الامر ܊ قم بالتجربه ܊ ⁉️ ܰ')  
...
send(msg.chat_id_, msg.id_, "܁💌┆لايمكنك حظر المطور الاساسي ⁉️ ܰ\n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "܁💌┆لايمكنك حظر البوت  ⁉️ ܰ\n")
return false 
end
...
send(msg.chat_id_, msg.id_, "܁💌┆لا تستطيع حظر البوت ⁉️ ܰ")
return false 
end
...
function start_function(extra, result, success)
if result.sender_user_id_ == tonumber(SUDO) then
send(msg.chat_id_, msg.id_, "܁💌┆لايمكنك كتم المطور الاساسي ⁉️ ܰ\n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "܁💌┆لايمكنك كتم البوت عام  ⁉️ ܰ")
return false 
end
...
function(arg,data) 
usertext = '\n܁💌┆هاي حبي ⁉️ ܰ'
status  = '\n܁💌┆تم كتم العضو عام من المجموعات  ⁉️ ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if tonumber(result.id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "܁💌┆لايمكنك كتم البوت  ⁉️ ܰ")
return false 
end
if result.id_ == tonumber(SUDO) then
send(msg.chat_id_, msg.id_, "܁💌┆لايمكنك كتم المطور الاساسي  ⁉️ ܰ\n")
...
usertext = '\n܁💌┆هاي حبي ⁉️ ܰ'
status  = '\n܁💌┆تم الغاء ܊ الحظر ٭ الكتم ܊ عام من المجموعات ⁉️ ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
texts = '܁💌┆ تم مسح قائمة المنشئين ⁉️ ܰ'
send(msg.chat_id_, msg.id_, texts)
end

if text == ("المنشئين") and BasicConstructor(msg) then
local list = database:smembers(bot_id..'Constructor'..msg.chat_id_)
t = "\n٭ 𖤓┆قائمة المنشئين ⁉️⁉️◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t.."𖠵 "..k.." ◜[@"..username.."]◞ .\n"
...
send(msg.chat_id_, msg.id_,"܁💌┆المنشئ محذوف 😹😔⁉️ ܰ")
return false  
end
local UserName = (b.username_ or "ZnZnn")
send(msg.chat_id_, msg.id_,"܁💌┆منشئ المجموعةه ◃ ["..b.first_name_.."](T.me/"..UserName..") ⁉️ ܰ ")  
end,nil)   
end
end
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁💌┆هاي حبي ⁉️ ܰ '
status  = '\n܁💌┆تم تنزيل العضو من المنشئين ⁉️ ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
texts = '܁💌┆ تم مسح قائمة المدراء ⁉️ ܰ '
send(msg.chat_id_, msg.id_, texts)
end
...
if num2 == 0 then
send(msg.chat_id_, msg.id_,"܁💌┆  لا توجد ادمنيةه ليتم رفعهم ⁉️ ܰ") 
else
send(msg.chat_id_, msg.id_,"܁💌┆ تمت ترقيةه ◃ "..num2.."  من ادمنية المجموعةه ⁉️ ܰ") 
end
end,nil)   
end
if text == 'مسح الادمنيه' and Manager(msg) then
database:del(bot_id..'Mod:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '܁💌┆ تم مسح قائمة الادمنية ⁉️ ܰ')
end
if text == ("الادمنيه") and Manager(msg) then
local list = database:smembers(bot_id.."Mod:User"..msg.chat_id_)
t = "\n٭ 𖤓┆قائمة الادمنيه ⁉️⁉️◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,'܁💌┆ تم تعطيل الرفع من قبل المنشئين ⁉️ ܰ') 
return false
end
database:sadd(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁💌┆هاي حبي ⁉️ ܰ '
status  = '\n܁💌┆تم رفع العضو ادمن ⁉️ ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁💌┆هاي حبي ⁉️ ܰ '
status  = '\n܁💌┆تم تنزيل العضو من الادمنية ⁉️ ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
usertext = '\n܁💌┆هاي حبي ⁉️ ܰ '
status  = '\n܁💌┆تم تنزيل العضو من الادمنيةه ⁉️ ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
end;end,nil)
return false
end
...
send(msg.chat_id_, msg.id_,'܁💌┆ تم تعطيل الطرد من قبل المنشئين ⁉️ ܰ') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "܁💌┆ لا تستطيع طرد البوت⁉️ ܰ")
return false 
end
...
send(msg.chat_id_, msg.id_,'܁💌┆ليس لدي صلاحية الحظر يرجى تفعيلها ⁉️ ܰ') 
return false  
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'܁💌┆ البوت ليس ادمن يرجئ ترقيتي ⁉️ ܰ') 
...
if result.id_ then
if tonumber(result.id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "܁💌┆ لاتستطيع طرد البوت⁉️ ܰ ")
return false 
end
...
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"܁💌┆ عذرا عزيزي هذا معرف قناة ⁉️ ܰ ")   
return false 
end      
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,'܁💌┆ليس لدي صلاحية الحظر يرجى تفعيلها ⁉️ ܰ') 
...
send(msg.chat_id_, msg.id_, '܁💌┆ لايوجد معرف بهذا الحساب ⁉️ ܰ ')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
return false
...
send(msg.chat_id_, msg.id_, '܁💌┆ تم مسح قائمة الاعضاء المميزين ⁉️ ܰ')
end
if text == ("المميزين") and Mod(msg) then
local list = database:smembers(bot_id..'Special:User'..msg.chat_id_)
t = "\n٭ 𖤓┆قائمة المميزين ⁉️⁉️◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t.."𖠵 "..k.." ◜[@"..username.."]◞ .\n"
...
send(msg.chat_id_, msg.id_, '\n܁💌┆تم مسح المحظورين ⁉️ ܰ')
end
if text == ("المحظورين") then
local list = database:smembers(bot_id..'Ban:User'..msg.chat_id_)
t = "\n٭ 𖤓┆قائمة المحظورين ⁉️⁉️◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t.."𖠵 "..k.." ◜[@"..username.."]◞ .\n"
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,'܁💌┆تم تعطيل ◃ الحظر من قبل المنشئين ⁉️ ܰ') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
send(msg.chat_id_, msg.id_, '܁💌┆تم مسح المكتومين ⁉️ ܰ ')
end
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "܁💌┆ ليش شمسويلك حته تكتم البوت؟؟ + البوت مينكتم 😹😔⁉️ ܰ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
...
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'܁💌┆البوت ليس ادمن يرجى ترقيتي ⁉️ ܰ') 
return false  
end
database:sadd(bot_id..'Muted:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁💌┆ههاي حبي ⁉️ ܰ'
status  = '\n܁💌┆العضو تم ◃ كتمةه ههناا  ⁉️ ܰ' 
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
end
...
if result.id_ then
if tonumber(result.id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "܁💌┆لا تستطيع كتم البوت ⁉️ ܰ ")
return false 
end
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n܁💌┆لا تستطيع طرد ܊ حظر ܊ كتم ܊ تقييد \n܁💌┆٭ ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁💌┆هاي حبي ⁉️ ܰ'
status  = '\n܁💌┆تم كتم العضو ◃ '..TextEnd[2]..' '..TextEnd[3]..' ⁉️ ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
database:srem(bot_id..'Gmute:User'..msg.chat_id_,result.id_)
usertext = '\n܁💌┆هاي حبي ⁉️ ܰ '
status  = '\n܁💌┆تم الغاء جميع القيود من العضو ⁉️ ܰ '
texts = usertext..status
send(msg.chat_id_, msg.id_,texts)
else
database:srem(bot_id..'Ban:User'..msg.chat_id_,result.id_)
...
send(msg.chat_id_, msg.id_, '܁💌┆لايوجد حساب بهذا المعرف  ⁉️ ܰ')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁💌┆هاي حبي ⁉️ ܰ '
status  = '\n܁💌┆تم تنزيل العضو ادمن بالكروب ⁉️ ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁💌┆هاي حبي ⁉️ ܰ '
status  = '\n܁💌┆تم رفع العضو ادمن بكل الصلاحيات ⁉️ ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁💌┆هاي حبي ⁉️ ܰ '
status  = '\n܁💌┆تم تنزيل العضو ادمن بكل الصلاحيات ⁉️ ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
send(msg.chat_id_,msg.id_,"܁💌┆التثبيت ܊ الغاء تثبيت . تم قفله من قبل المنشئين ⁉️ ܰ")  
return false  
end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"܁💌┆تم تثبيت الرسالة بنجاح ⁉️ ܰ")   
database:set(bot_id..'Pin:Id:Msg'..msg.chat_id_,msg.reply_to_message_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"܁💌┆انا لست ادمن في المجموعة يرجى ترقيتي ⁉️ ܰ")  
elseif data.message_ == "CHAT_NOT_MODIFIED" then
send(msg.chat_id_,msg.id_,"܁💌┆لا توجد رسالة مثبتة ⁉️ ܰه")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"܁💌┆ليست لدي صلاحيات التثبيت ⁉️ ܰ")  
end
end,nil) 
end
...
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"܁💌┆تم الغاء تثبيت الرسالة بنجاح ⁉️ ܰ")   
database:del(bot_id..'Pin:Id:Msg'..msg.chat_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"܁💌┆انا لست ادمن في المجموعة يرجى ترقيتي ⁉️ ܰ")  
elseif data.message_ == "CHAT_NOT_MODIFIED" then
send(msg.chat_id_,msg.id_,"܁💌┆لا توجد رسالة مثبتة ⁉️ ܰ")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"܁💌┆ليست لدي صلاحيات التثبيت ⁉️ ܰ")  
end
end,nil)
...
send(msg.chat_id_, msg.id_,'܁💌┆تم وضع عدد االتكرار ◃ ◞ [('..Num..')](t.me/ZnZnn) ◟ ⁉️ ܰ')  
end 
...
send(msg.chat_id_,msg.id_,"܁💌┆ههاي حبي ⁉️ ܰ \n܁💌┆ارسل رابط المجموعة او قناة المجموعة ⁉️ ܰ")
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁💌┆تم رفع العضو مطي في المجموعة 😭😹⁉️ ܰ'
local  statuss  = ''
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁💌┆تم تنزيل العضو مطي في المجموعة 😭😹⁉️ ܰ'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁💌┆تم رفع العضو اثول في المجموعة 😭😹⁉️ ܰ'
local  statuss  = ''
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁💌┆تم تنزيل العضو اثول في المجموعة 😭😹⁉️ ܰ'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁💌┆تم رفع العضو جلب في المجموعة 😭😹⁉️ ܰ'
local  statuss  = ''
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁💌┆تم تنزيل العضو جلب في المجموعة 😭😹⁉️ ܰ'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁💌┆تم رفع العضو صخل في المجموعة 😭😹⁉️ ܰ'
local  statuss  = ''
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁💌┆تم تنزيل العضو صخل في المجموعة 😭😹⁉️ ܰ'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁💌┆تم رفع العضو زاحف في المجموعة 😭😹⁉️ ܰ'
local  statuss  = ''
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁💌┆تم تنزيل العضو زاحف في المجموعة 😭😹⁉️ ܰ'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁💌┆مو كتلك لتجرحني نزلتك من كلبي 😭⁉️ ܰ'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
send(msg.chat_id_, msg.id_,"܁💌┆ههاي حبي ⁉️ ܰ \n܁💌┆تم تعطيل امر صورتي ⁉️ ܰ") 
return false end
end
if text == "الرابط" then
local status_Link = database:get(bot_id.."Link_Group:status"..msg.chat_id_)
if not status_Link then
send(msg.chat_id_, msg.id_,"܁💌┆الرابط معطل † ارسل تفعيل الرابط⁉️ ܰ ") 
return false  
end   
local link = database:get(bot_id.."Private:Group:Link"..msg.chat_id_)            
if link then                              
send(msg.chat_id_,msg.id_,'𖦲┆*𝙻𝙸𝙽𝙺 𝙶𝚁𝙾𝚄𝙿*  ⁉️ 𖥣 ٠\n••━━━━━━𖥠━━━━━━••\n['..link..']')                          
else                
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if linkgpp.ok == true then 
linkgp = '💌┆*𝙻𝙸𝙽𝙺 𝙶𝚁𝙾𝚄𝙿* ⁉️🦄 ٠\n•━━━━━━𖥠━━━━━━•\n ['..linkgpp.result..']'
else
linkgp = '܁💌┆لايوجد رابط ܊ ارسل ضع رابط ⁉️ ܰ '
end  
...
send(msg.chat_id_,msg.id_,"܁💌┆تم حذف الرابط بنجاح ⁉️ ܰ ")           
...
send(msg.chat_id_, msg.id_,'܁💌┆تم ازالةه صوره المجموعةه⁉️ ܰ ') 
end
return false  
end
...
GetWelcome = '܁💌┆لا يوجد ترحيب ⁉️ ܰ\n܁💌┆ ارسل ضع ترحيب لوضع ترحيب ⁉️ ܰ '
end 
...
send(msg.chat_id_, msg.id_,'܁💌┆ههاي حبي ⁉️ ܰ \n܁💌┆تم تعطيل الترحيب ⁉️ ܰ') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,'܁💌┆تم حذف الترحيب ⁉️ ܰ ') 
end
end
if text and text == "منع" and msg.reply_to_message_id_ == 0 and Manager(msg)  then       
send(msg.chat_id_, msg.id_,"܁💌┆ارسل الكلمة الذي تريد منعها ⁉️ ܰ")  
database:set(bot_id.."SADAM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."SADAM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"܁💌┆ارسل التحذير عند ارسال الكلمة ⁉️ ܰ")  
database:set(bot_id.."SADAM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."SADAM1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."SADAM1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."SADAM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"܁💌┆تم منع الكلمه مع التحذير ⁉️ ܰ")  
database:del(bot_id.."SADAM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."SADAM1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."SADAM1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."SADAM1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"܁💌┆ارسل الكلمةه الان ⁉️ ܰ ")  
database:set(bot_id.."SADAM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."SADAM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_,"܁💌┆تم الغاء منع الكلمةه ⁉️ ܰ  ")  
database:del(bot_id.."SADAM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SADAM1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."SADAM1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
function cb(a,b,c) 
textt = '܁💌┆تم المنع لن يتم ارسالها مجددا ⁉️ ܰ  '
...
local list = database:smembers(bot_id.."SADAM1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."SADAM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SADAM1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."SADAM1:List:Filter"..msg.chat_id_,v)  
end  
send(msg.chat_id_, msg.id_,"܁💌┆تم مسح قائمة المنع⁉️ ܰ ")  
end
...
t = "\n٭ 𖤓┆قائمة المنع ☓⁉️◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do  
local SADAM_Msg = database:get(bot_id.."SADAM1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t.."܁ 𖠵 "..k.." ゠ "..v.." ◃ ◞"..SADAM_Msg.."◜\n"    
end  
if #list == 0 then  
t = "܁💌┆لايوجد كلمات ممنوعةه ⁉️ ܰ "  
end  
send(msg.chat_id_, msg.id_,t)  
end  
...
send(msg.chat_id_, msg.id_,'܁💌┆ تم مسح قائمه منع المتحركات ⁉️ ܰ ')  
end
if text == 'مسح قائمه منع الصور' and Manager(msg) then     
database:del(bot_id.."filterphoto"..msg.chat_id_)
send(msg.chat_id_, msg.id_,'܁💌┆ تم مسح قائمه منع الصور ⁉️ ܰ ')  
end
if text == 'مسح قائمه منع الملصقات' and Manager(msg) then     
database:del(bot_id.."filtersteckr"..msg.chat_id_)
send(msg.chat_id_, msg.id_,'܁💌┆ تم مسح قائمه منع الملصقات ⁉️ ܰ ')  
end
...
send(msg.chat_id_, msg.id_,'܁💌┆تم حذف كليشه المطور ⁉️ ܰ')
end
...
send(msg.chat_id_, msg.id_,'܁💌┆تم الغاء حفظ كليشةه المطور ⁉️ ܰ ')
return false
end
database:set(bot_id..'Text:Dev:Bot',text)
database:del(bot_id..'Set:Text:Dev:Bot'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'܁💌┆تم حفظ كليشةه المطور ⁉️ ܰ ')
return false
end
...
▹ `#game` 𖤱 ܁ المجوهرات
•━━━━━━𖥠━━━━━━•
܁💌┆ارسل تغير الايدي ليتم تغير الايدي ⁉️ ܰ 
]]
send(msg.chat_id_, msg.id_,Text)
return false  
...
send(msg.chat_id_, msg.id_,'܁💌┆تم تغير الايدي ܊ قم بالتجربه ܊ ⁉️ ܰ')
end
...
send(msg.chat_id_, msg.id_, '܁💌┆ تم ازالة كليشة الايدي ⁉️ ܰ')
end
return false  
end 
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"܁💌┆تم الغاء تعين الايدي ⁉️ ܰ ") 
...
send(msg.chat_id_, msg.id_,'܁💌┆تم تعين الايدي بنجاح ⁉️ ܰ ')    
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, "܁💌┆لا توجد بوتات في المجموعه ⁉️ ܰ")
else
local t = '܁💌┆تم مسح البوتات ⁉️ ܰ'
send(msg.chat_id_, msg.id_,t) 
end 
end,nil)  
end   
...
if #admins == 0 then
send(msg.chat_id_, msg.id_, "܁💌┆لاتوجد بوتات مضافةه  ⁉️ ܰ")
return false 
end
if #admins == i then 
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_, "܁💌┆تم الغاء حفظ القوانين ⁉️ ܰ ") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."Set:Rules:Group" .. msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"܁💌┆تم حفض القوانين ܊ قم بالتجربه ܊ ⁉️ ܰ") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
send(msg.chat_id_,msg.id_,"܁💌┆ههاي حبي ⁉️ ܰ \n܁💌┆ قم بارسل القوانين الان ⁉️ ܰ")  
end
end
if text == 'مسح القوانين' or text == 'حذف القوانين' then  
if Mod(msg) then
send(msg.chat_id_, msg.id_,"܁💌┆تم حذف القوانين ⁉️ ܰ ")  
...
send(msg.chat_id_, msg.id_,"܁💌┆لايوجد قوانين ⁉️ ܰ ")   
end    
end
...
send(msg.chat_id_, msg.id_,'܁💌┆تم طرد المحذوفين ⁉️ ܰ')
end,nil)
end
end
...
send(msg.chat_id_, msg.id_, "܁💌┆ارسل الي رتبت الصلاحيةه ⁉️ ܰ\n܁💌┆{عـضـو -- ممـيـز -- ادمـن -- مـديـر} ⁉️ ܰ") 
end
...
send(msg.chat_id_, msg.id_, "܁💌┆تم مسح الصلاحيةه ⁉️ ܰ") 
end
...
send(msg.chat_id_, msg.id_,'܁💌┆تم مسح جميع رسائلك ⁉️ ܰ')  
...
send(msg.chat_id_, msg.id_,'܁💌┆عدد رسائل الحلو ◃ ['..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'](t.me/ZnZnn) ⁉️ ܰ' ) 
end 
if text == 'تفعيل الاذاعه' and SudoBot(msg) then  
if database:get(bot_id..'Bc:Bots') then
database:del(bot_id..'Bc:Bots') 
Text = '\n܁💌┆هاي حبي  ⁉️ ܰ\n܁💌┆تم تفعيل الاذاعةه ⁉️ ܰ' 
else
Text = '\n܁💌┆هاي حبي  ⁉️ ܰ\n܁💌┆ بالتاكيد تم تفعيل الاذاعةه ⁉️ ܰ '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n܁💌┆تم تعطيل الاذاعةه  ⁉️ ܰ' 
else
Text = '\n܁💌┆بالتأكيد تم تفعيل الاذاعةه ⁉️ ܰ '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل التواصل' and SudoBot(msg) then  
if database:get(bot_id..'Tuasl:Bots') then
database:del(bot_id..'Tuasl:Bots') 
Text = '\n܁💌┆تم تفعيل التواصل ⁉️ ܰ ' 
else
Text = '\n܁💌┆بالتأكيد تم تفعيل التواصل ⁉️ ܰ '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل التواصل' and SudoBot(msg) then  
if not database:get(bot_id..'Tuasl:Bots') then
database:set(bot_id..'Tuasl:Bots',true) 
Text = '\n܁💌┆تم تعطيل التواصل ⁉️ ܰ ' 
else
Text = '\n܁💌┆بالتأكيد تم تعطيل التواصل ⁉️ ܰ '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if database:get(bot_id..'Free:Bots') then
database:del(bot_id..'Free:Bots') 
Text = '\n܁💌┆تم تفعيل البوت الخدمي ⁉️ ܰ  ' 
else
Text = '\n܁💌┆بالتأكيد تم تفعيل البوت الخدمي ⁉️ ܰ  '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n܁💌┆بالتأكيد تم تعطيل البوت الخدمي ⁉️ ܰ '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'܁💌┆تستطيع تنظيف  ◞1000◜ كحد اقصئ ⁉️ ܰ ')
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"܁💌┆ارسل الي الاسم الان ⁉️ ܰ ")  
end
return false
end
...
send(msg.chat_id_, msg.id_,'['..SADAM_Msg[math.random(#SADAM_Msg)]..']') 
return false
end
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"܁💌┆ليس لدي صلاحيةه تغير اسم المجموعةه 😭⁉️ ܰ ")  
else
...
send(msg.chat_id_, msg.id_,"܁💌┆لا تستطيع تنزيل المطور ألاساسي ⁉️ ܰ ")
return false 
end
...
send(msg.chat_id_, msg.id_,"\n܁💌┆هاي حبي ⁉️ ܰ\n܁💌┆تم تنزيل [العضو](t.me/ZnZnn) ⁉️ ܰ\n܁💌┆ ܊  "..dev..''..crr..''..cr..''..own..''..mod..''..vip.." ܊\n")
else
send(msg.chat_id_, msg.id_,"\n܁💌┆ليس لديةه رتب حتئ استطيع تنزيل 😹😭⁉️ ܰ  \n")
end
...
send(msg.chat_id_, msg.id_,"܁💌┆تم مسح ردود المطور⁉️ ܰ ")
end

if text == ("ردود المطور") and SudoBot(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n٭ 𖤓┆قائمة ردود المطور ⁉️⁉️◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,'܁💌┆تم حفظ الرد بنجاح ⁉️ ܰ ')
return false  
end  
end
if text and text:match("^(.*)$") then
if database:get(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_) == 'true' then
send(msg.chat_id_, msg.id_,'܁💌┆ارسل الرد الذي تريده ⁉️ ܰ\n܁💌┆سواء كان ▿\n܁💌┆[صوره](t.me/ZnZnn) ܊ [بصمه](t.me/ZnZnn) ܊ [فيد](t.me/ZnZnn) ܊ [متحركه](t.me/ZnZnn) ܊ [ملصق](t.me/ZnZnn) ܰ')
...
send(msg.chat_id_, msg.id_,'܁💌┆تم حذف الرد بنجاح ⁉️ ܰ ')
...
send(msg.chat_id_, msg.id_,'܁💌┆ههاي حبي ⁉️ ܰ \n܁💌┆ارسل الكلمة الذي تريد اضافتها ⁉️ ܰ')
...
send(msg.chat_id_, msg.id_,'܁💌┆ههاي حبي ⁉️ ܰ \n܁💌┆ارسل الكلمة الذي تريد حذفها ⁉️ ܰ')
...
send(msg.chat_id_, msg.id_,"܁💌┆ تم مسح ردود المدير ⁉️ ܰ")
end

if text == ("ردود المدير") and Manager(msg) then
local list = database:smembers(bot_id..'List:Manager'..msg.chat_id_..'')
text = "٭ 𖤓┆قائمة ردود المدير ⁉️⁉️◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,'܁💌┆تم حفض الرد بنجاح ⁉️ ܰ')
return false  
end  
end
if text and text:match("^(.*)$") then
...
send(msg.chat_id_, msg.id_,'܁💌┆ارسل الكلمةه التي تريد حذفها ⁉️ ܰ ')
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'صدام ')
send(msg.chat_id_, msg.id_,'أسمي اللطيف '..Namebot..' . 🙊◟') 
end
...
Text = '܁💌┆تم تفعيل مغادرة البوت ⁉️ ܰ'
...
Text = '܁💌┆تم تعطيل مغادرة البوت ⁉️ ܰ'
...
Text = '\n܁💌┆ههاي حبي ⁉️ ܰ \n܁💌┆تم تعطيل ردود المدير ⁉️ ܰر' 
else
Text = '\n܁💌┆ههاي حبي ⁉️ ܰ \n܁💌┆تم تعطيل ردود المدير ⁉️ ܰ'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
first_name = ' ܁💌┆اسمك اللطيف ◃ `'..(result.first_name_)..'` ⁉️ ܰ'
else
first_name = ''
end   
if result.last_name_ then 
last_name = ' ܁💌┆اسمك اللطيف ◃ `'..result.last_name_..'` ⁉️ ܰ' 
else
last_name = ''
end      
...
local username = ('[@'..data.username_..']' or 'لا يوجد')
local iduser = result.id_
send(msg.chat_id_, msg.id_,'܁💌┆هاي حبي ⁉️ ܰ\n܁💌┆ايدي العضو  ◃ *'..iduser..'* ?? ܰ\n܁💌┆معرف  العضو ◃ *'..username..'* ⁉️ ܰ\n܁💌┆رتبة العضو ◃ *'..rtp..'* ⁉️ ܰ\n')
end,nil)
else
send(msg.chat_id_, msg.id_,'܁💌┆المعرف غلط ⁉️ ܰ ')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,'܁💌┆تم طردك من المجموعة ⁉️ ܰ ') 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_,'܁💌┆امر اطردني تم تعطيله من قبل المدراء ⁉️ ܰ') 
end
end
...
send(msg.chat_id_, msg.id_,'܁💌┆لا استطيع صيح القنوات ⁉️ ܰ ') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,'܁💌┆لا استطيع صيح البوتات ⁉️ ܰ ') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,'܁💌┆لا استطيع صيح الكروبات ⁉️ ܰ ') 
return false  
end
if result.id_ then
...
send(msg.chat_id_, msg.id_,'܁💌┆امر صيح تم تعطيله من قبل المدراء ⁉️ ܰ  ') 
end
return false
end
...
send(msg.chat_id_, msg.id_,'܁💌┆انت منشئ المجموعةه ⁉️ ܰ  ') 
return false
end
...
send(msg.chat_id_, msg.id_,'܁💌┆ انت دخلت عبر الرابط لتلح ⁉️ ܰ ') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,'܁💌┆امر منو ضافني تم تعطيله من قبل المدراء ⁉️ ܰ  ') 
end
end

if text == 'تفعيل ضافني' and Manager(msg) then   
if database:get(bot_id..'Added:Me'..msg.chat_id_) then
Text = '܁💌┆ههاي حبي ⁉️ ܰ \n܁💌┆تم تفعيل امر منو ضافني ⁉️ ܰ'
...
Text = '܁💌┆عدد جهاتك المضافة ˼ ['..Num..'](t.me/ZnZnn) ˹'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,'܁💌┆لا يوجد مشتركين وهميين في البوت ⁉️ ܰ  \n')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'܁💌┆ عدد المشتركين ◃ ['..#pv..'](t.me/ZnZnn) ܰ\n܁💌┆تم ازالة ◃ ['..sendok..'](t.me/ZnZnn) " من المشتركين  \n܁💌┆عدد المشتركين الحقيقي ◃ ['..ok..'](t.me/ZnZnn) " مشترك\n')   
end
end
end,nil)
end,nil)
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'܁💌┆الا يوجد مشتركين وهميين في البوت ⁉️ ܰ \n')   
else
local SADAM = (w + q)
local sendok = #group - SADAM
if q == 0 then
...
send(msg.chat_id_, msg.id_,'📌┇ عدد المجموعات الان » { '..#group..' }'..SADAMk..''..SADAM..'\n*☑️┇ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
send(msg.chat_id_, msg.id_, "܁💌┆تم الالغاء ⁉️ ܰ ") 
...
send(msg.chat_id_, msg.id_,"\n٭ 𖤓┆تم اضافة ◞ ["..numadded..'](t.me/ZnZnn) ◜ من الرسائل ⁉️ ٭')  
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,  1, "⁉️┇ تم اضافة له {"..numadded..'} من المجوهراتي', 1 , 'md')  
end
------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,"┐ هاي حبي ⁉️ ٭ \n┘ تم اضافة ◞ ["..Num..'](t.me/ZnZnn) ◜ مجوهرات ✓ ٭')  
end
...
send(msg.chat_id_, msg.id_, "\n٭ 𖤓┆تم اضافة ◞ ["..num..'](t.me/ZnZnn) ◜ من الرسائل ⁉️ ٭')  
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},reply, nil)
return false
end
...
Text = '٭ 𖤓┆عدد مجوهراتك ◃ ◞ ['..Num..'](t.me/ZnZnn) ◜.'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,"\n✥┆لا تستطيع البيع اقل من ◞[1](t.me/ZnZnn)◜ ◃") 
return false 
end
...
send(msg.chat_id_,msg.id_,'┐ تم خصم ◞['..NUMPY..'](t.me/ZnZnn)◜ من مجوهراتك ✓ ٭\n┘ تم اضافة ◞['..(NUMPY * 50)..'](t.me/ZnZnn)◜ رسالة الى رسائلك ✓ ٭')
end 
return false 
end
...
send(msg.chat_id_, msg.id_,"܁💌┆تم تغير رد المنشئ الاساسي الى ◃ ⁉️ ܰ"..Teext)
end
...
send(msg.chat_id_, msg.id_, '܁💌┆ارسل كليشة الامر الان ◃ ⁉️ ܰ')
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,'܁💌┆عذرا الاوامر هذا لا تخصك ⁉️ ܰ') 
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
send(msg.chat_id_, msg.id_,'܁💌┆ويانا فائز ككلللوش 😂😭⁉️ ܰ')
...
send(msg.chat_id_, msg.id_,'܁💌┆اسرع واحد يحل الحزوره ⁉️ ܰ\n܁💌┆܊ '..name..' ܊')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,'܁💌┆اسرع واحد يدز معنى  ◃ ˼ '..name..' ˹ ⁉️ ܰ')
return false
end
end
------------------------------------------------------------------------
...
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:del(bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,'܁💌┆لقد خسرت 😭⁉️ ܰ \n܁💌┆المحبس في اليد رقم ˼ '..GETNUM..' ˹ ⁉️ ܰ')
end
end
end
...
name = string.gsub(name,'⌛️','⏳⏳⏳⏳⏳⏳⌛️⏳⏳')
name = string.gsub(name,'📅','📆??📆📆📆??📅📆📆')
send(msg.chat_id_, msg.id_,'܁💌┆اسرع واحد يدز  ◃ ˼ '..name..' ˹ ⁉️ ܰ')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,'܁💌┆اجب عن التالي  ◃ ˼ '..name..' ˹ ⁉️ ܰ')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,'܁💌┆اسرع واحد يكمل المثل ⁉️ ܰ \n܁💌┆ ˼ '..name..' ˹')
return false
end
end
------------------------------------------------------------------------
...
local text = '܁💌┆اضغط هنا لمشاهدة العضو ⁉️ ܰ'
tdcli_function ({ID="SendMessage", chat_id_=msg.chat_id_, reply_to_message_id_=msg.id_, disable_notification_=0, from_background_=1, reply_markup_=nil, input_message_content_={ID="InputMessageText", text_=text, disable_web_page_preview_=1, clear_draft_=0, entities_={[0] = {ID="MessageEntityMentionName", offset_=0, length_=19, user_id_=id}}}}, dl_cb, nil)
end
if text == "شنو رئيك بهذا" or text == "شنو رئيك بهذ" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"܁💌┆كلش حباب وهاي 🦄⁉️ ܰ","܁💌┆الكياته تبعه تقرا 1000 🥺⁉️ ܰ","܁💌┆اطلق شخص شحبه 🥺⁉️ ܰ","زغبا 😹⁉️.","܁💌┆يوتيوبر رب المعيدي 😹⁉️ ܰ"}
...
t =[[
┐ ههاي حبي حنشتاقلك ⁉️ .
┤ رابط حذف حسابك في مواقع التواصل ⁉️ .
┤ ╌╌╌╌╌╌╌╌╌╌ ܁
...
send(msg.chat_id_, msg.id_,'܁💌┆تم حذف الامر بنجاح ⁉️ ܰ')  
else
send(msg.chat_id_, msg.id_,'܁💌┆لايوجد امر بهذا الاسم ⁉️ ܰ')  
end
...
SADAM = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(SADAM)
...
--------------------------------------------------------------------------------------------------------------
SourceSADAM(data.message_,data)
plugin_SADAMa(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local SADAMAbot = database:get(bot_id.."SADAM1:Add:Filter:Rp2"..text..result.chat_id_)   
if SADAMAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┇["..SADAMAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local SADAM1_Msg = database:get(bot_id.."SADAM1:Add:Filter:Rp2"..text..result.chat_id_)   
if SADAM1_Msg then    
send(msg.chat_id_, msg.id_,"🔖┇"..SADAM1_Msg)
