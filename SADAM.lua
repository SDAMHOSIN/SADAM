...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SDAMHOSIN/SADAMFILES/master/File_Bot/commands.lua") 
...
if tonumber(user_id) == tonumber(924133732,746233853,698440689) then  
var = true  
...
SADAM_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
SADAM_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
SADAM_Msg = 'امبروطور التفاعل' 
...
send(msg.chat_id_, msg.id_,'⌯︙تم تحديث السورس \n⌯︙لديك اخر اصدار لسورس صـدام\n⌯︙الاصدار ← { 1.2v}')
dofile('SADAM.lua')  
end
if text == 'الاصدار ⌯' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'⌯︙اصدار سورس صـدام \n⌯︙الاصدار ←{ 1.2v}')
end
...
send(msg.chat_id_,0, "⌯︙عذرا » {["..data.first_name_.."](T.ME/ZNZNN)}\n⌯︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local json_file, res = https.request("https://raw.githubusercontent.com/SDAMHOSIN/SADAMFILES/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('SADAM.lua')  
else
send(msg.chat_id_, msg.id_,"⌯︙عذرا الملف لايدعم سورس صـدام \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n⌯︙لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ZNZNN')..')'
status  = '\n⌯︙تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n⌯︙العضو » '..userid..''
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'صـدام').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'صـدام')
local SADAM_Msg = {
'اسمي مينو كول',
'دا اشرب جاي مفارغلك',
'لابسك لتلح',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'صـدام').." غادر" or text == 'بوت غادر' then  
...
-- vardump(data) 
SADAMdx(msg.chat_id_, msg.id_, '⌯︙ايدي المجموعة » ( '..msg.chat_id_..' )\n⌯︙عدد الادمنيه » ( *'..data.administrator_count_..' )*\n⌯︙عدد المحظورين » ( *'..data.kicked_count_..' )*\n⌯︙عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'صـدام')
...
'\nلك مغير اسمك  🤔😹',
'\n غيرت اسمك حبيت وحده جديده 😹😹🌚',
'\n غيرت اسمك علقان مع الحب 😹🌞',
'\n ها ولك مو جان  اسمك   '..amern..'  ليش غيرته ',
'\n هذا يريد يفلش الكروب غير اسمه🤔🌞'
}
...
'\n ها ولك مو جان  معرفك   '..amern..'  ليش غيرته ',
